      ...
      <fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-1.0">
        ...
        <fee:cd avail="1">
          ...
          <fee:command name="create">
            ...
            <fee:fee description="Registration Fee" refundable="1" grace-period="P5D">10.00</fee:fee>
          </fee:command>
          <fee:command name="renew">
            <fee:period unit="y">1</fee:period>
            <fee:fee description="Renewal Fee" refundable="1" grace-period="P5D">5.00</fee:fee>
          </fee:command>
          <fee:command name="transfer">
            <fee:period unit="y">1</fee:period>
            <fee:fee description="Transfer Fee" refundable="1" grace-period="P5D">5.00</fee:fee>
          </fee:command>
          <fee:command name="restore">
            <fee:fee description="Redemption Fee">5.00</fee:fee>
          </fee:command>
        </fee:cd>
        <fee:cd avail="1">
        ...
        <fee:cd avail="0">
          ...
          <fee:command name="create">
            <fee:period unit="y">2</fee:period>
            <fee:reason>Only 1 year registration periods are valid.</fee:reason>
          </fee:command>
        </fee:cd>
      </fee:chkData>
    </extension>
...
class feeEppCheckDomainResponse extends eppCheckDomainResponse {
    ...
    public function getFees() {
        $xpath = $this->xPath();
	    $xpath->registerNamespace('fee', 'urn:ietf:params:xml:ns:fee-1.0');
