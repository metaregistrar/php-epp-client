...
class atEppDeleteDomainRequest extends eppDeleteDomainRequest {
    ...
    function __construct(eppDomain $deleteinfo, $namespacesinroot = true, $scheduledate = self::SCHEDULE_DELETE_NOW) {
    ...
    public function addATScheduledateExtension($scheduleType) {
        ...
        //$deleteext->setAttribute('xsi:schemaLocation', 'http://www.nic.at/xsd/at-ext-domain-1.0 at-ext-domain-1.0.xsd');
