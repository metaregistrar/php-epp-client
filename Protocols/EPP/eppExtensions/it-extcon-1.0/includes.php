...
include_once(dirname(__FILE__) . '/eppRequests/itEppUpdateContactRequest.php');
...
$this->addCommandResponse('Metaregistrar\EPP\itEppUpdateContactRequest', 'Metaregistrar\EPP\eppUpdateContactResponse');
