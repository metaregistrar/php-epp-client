...
include_once(dirname(__FILE__).'/eppDomain.php');
include_once(dirname(__FILE__).'/eppHost.php');
include_once(dirname(__FILE__).'/eppSecdns.php');
include_once(dirname(__FILE__).'/eppIDNA.php');
